...
public class CustomerSystemInterfaceBehaviour extends CyclicBehaviour {
    ...
    /* JSONObject Array for tests */
    static JSONObject[] GeneratedOffer = new JSONObject[1];
    ...
    public void handleCustomerMessage(ACLMessage msg) {
        ...
        JSONObject jsonOffer = new JSONObject(content);
        GeneratedOffer[0]=jsonOffer;

        System.out.println("Offer generated by Interface: " + content);
